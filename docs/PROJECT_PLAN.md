...
StoryVerse 是一个中文优先的 Web 创作工具。它以统一的故事节点为核心，把世界观、
角色、故事线、时间轴、伏笔和正文连接起来，并允许用户按需使用 AI 辅助创作。
...
- 原始文档的动画、协作和平台化能力继续保留，但延后实现。

### 后续通过原型验证

- 故事线画布最终使用 React Flow 还是 Konva。
